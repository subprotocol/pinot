...
public class PinotTableRestletResource {
  ...
  public String rebalance(
      ...
      @ApiParam(value = "True if you are trying to bootstrap replica groups for a table. "
          + "False if you are rebalancing the replica group table or other typed table")
        @DefaultValue("false") @QueryParam("replicaGroupBootstrap") Boolean bootstrap) {
    ...
    rebalanceUserConfig.addProperty(RebalanceUserConfigConstants.REPLICA_GROUP_BOOTSTRAP, bootstrap);
